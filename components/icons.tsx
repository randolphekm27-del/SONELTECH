...
export const X: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><line x1="18" x2="6" y1="6" y2="18"></line><line x1="6" x2="18" y1="6" y2="18"></line></svg>
);
...
export const Twitter: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M22 4s-.7 2.1-2 3.4c1.6 1.4 3.3 4.9 3.3 4.9-6.1 1.2-12.1 6.4-12.1 6.4s-9.2-6.4-9.2-12.1c0 0 3.2 2.1 6.4 3.3 2.1-2.1 4.9-3.3 4.9-3.3s.7-.7 1.4-.7c.7 0 1.4.7 1.4.7z"></path></svg>
);
...
export const Lightbulb: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M9 19a7 7 0 0 1 6.32-9.92 5.5 5.5 0 0 0-1.03-4.38C12.44 2.88 10.29 2 8 2a8 8 0 0 0-8 8c0 4.42 3.58 8 8 8Z"></path><path d="M12 22v-2.08"></path><path d="M9.9 21.41 12 19.33"></path><path d="m3.55 12.6-2.1-2.1"></path><path d="M8.2 3.8 6.1 1.7"></path><path d="M17.45 12.6 19.55 10.5"></path></svg>
);

export const Leaf: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M11 20A7 7 0 0 1 4 13V8a5 5 0 0 1 9-3 5 5 0 0 1 9 3v5a7 7 0 0 1-7 7h-1Z"></path><path d="M11 20v-9"></path></svg>
);